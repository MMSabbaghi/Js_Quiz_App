...
function setQuestion(number) {
    ...
    document.getElementById('choices').innerHTML = createChoiceElements(currentQuestion);
...
function configBtns() {
    nextQuestionBtn.disabled = (currentQuestionNumber == questions.length);
    previousQuestionBtn.disabled = (currentQuestionNumber == 1);
    endQuizBtn.style.visibility = (currentQuestionNumber == questions.length) ? "visible" : "hidden";
}
